...
const App = () => {
  ...
  const [productos] = useState([
    //COMBINADOS
    { id: 1, nombre: 'Combinado 15p', precio: 17000, cat: 'COMBINADOS', img: 'productos/combinado-15p.webp' }, 
    { id: 2, nombre: 'Combinado 30p', precio: 33600, cat: 'COMBINADOS', img: 'productos/combinado-30p.webp'}, 
    { id: 3, nombre: 'Combinado 45p', precio: 50200, cat: 'COMBINADOS', img: 'productos/combinado-45p.webp'}, 
    { id: 4, nombre: 'Combinado 60p', precio: 67200, cat: 'COMBINADOS', img: 'productos/combinado-60p.webp'}, 
    { id: 5, nombre: 'Roll & Roll 30p', precio: 37800, cat: 'COMBINADOS', img: 'productos/roll-y-roll-30p.webp'},
    { id: 6, nombre: 'Sushi Fan 30p', precio: 35800, cat: 'COMBINADOS', img: 'productos/sushi-fan-30p.webp'}, 
    //ROLLS
    { id: 7, nombre: 'Avocado 8p', precio: 8600, cat: 'ROLLS', img: 'productos/avocado-8p.webp'}, 
    { id: 8, nombre: 'Buenos Aires 8p', precio: 9900, cat: 'ROLLS', img: 'productos/buenos-aires-8p.webp'}, 
    { id: 9, nombre: 'California 8p', precio: 6400, cat: 'ROLLS', img: 'productos/california-8p.webp'},  
    { id: 11, nombre: 'Citrus 8p', precio: 8600, cat: 'ROLLS', img: 'productos/citrus-8p.webp'}, 
    { id: 12, nombre: 'Crazy 8p', precio: 8000, cat: 'ROLLS', img: 'productos/crazy-8p.webp'}, 
    { id: 13, nombre: 'Ebi Tempura 8p', precio: 7600, cat: 'ROLLS', img: 'productos/ebi-tempura-8p.webp'}, 
    { id: 14, nombre: 'Feel 8p', precio: 9900, cat: 'ROLLS', img: 'productos/feel-8p.webp'}, 
    { id: 15, nombre: 'Furay 8p', precio: 9100, cat: 'ROLLS', img: 'productos/furay-8p.webp'}, 
    { id: 16, nombre: 'Futurama 8p', precio: 9900, cat: 'ROLLS', img: 'productos/futurama-8p.webp'},
    { id: 17, nombre: 'Honey 8p', precio: 9500, cat: 'ROLLS', img: 'productos/honey-8p.webp'},  
    { id: 19, nombre: 'Philadelphia 8p', precio: 9800, cat: 'ROLLS', img: 'productos/philadelphia-8p.webp'}, 
    { id: 20, nombre: 'Placer Real 8p', precio: 12100, cat: 'ROLLS', img: 'productos/placer-real-8p.webp'}, 
    { id: 21, nombre: 'Spf 8p', precio: 8600, cat: 'ROLLS', img: 'productos/spf-8p.webp'}, 
    { id: 22, nombre: 'Sc Evolution 8p', precio: 8000, cat: 'ROLLS', img: 'productos/sc-evolution-8p.webp'}, 
    { id: 23, nombre: 'Smoke 8p', precio: 9000, cat: 'ROLLS', img: 'productos/smoke-8p.webp'}, 
    { id: 24, nombre: 'Soul 8p', precio: 12100, cat: 'ROLLS', img: 'productos/soul-8p.webp'}, 
    { id: 25, nombre: 'Sweet 8p', precio: 8000, cat: 'ROLLS', img: 'productos/sweet-8p.webp'},
    //COCINA
    { id: 26, nombre: 'Arrollados Primavera 3u', precio: 8000, cat: 'COCINA', img: 'productos/arrollados-primavera-3u.webp'},
    { id: 27, nombre: 'Boom 6u', precio: 6500, cat: 'COCINA', img: 'productos/boom-6u.webp'}, 
    { id: 28, nombre: 'Langostinos Rebozados 6u', precio: 8900, cat: 'COCINA', img: 'productos/langostinos-rebozados-6u.webp'}, 
    { id: 29, nombre: 'Rabas 150gr', precio: 9900, cat: 'COCINA', img: 'productos/rabas-150gr.webp'},
    //MAKIS
    { id: 30, nombre: 'Maki Salmon 8p', precio: 8900, cat: 'MAKIS', img: 'productos/maki-salmon-8p.webp'}, 
    { id: 31, nombre: 'Maki Philadelphia 8p', precio: 8000, cat: 'MAKIS', img: 'productos/maki-philadelphia-8p.webp'}, 
    { id: 32, nombre: 'Maki Vegetariano 8p', precio: 4100, cat: 'MAKIS', img: 'productos/maki-vegetariano-8p.webp'}, 
    { id: 33, nombre: 'Maki Tuna 8p', precio: 6300, cat: 'MAKIS', img: 'productos/maki-tuna-8p.webp' },
    //TEMAKIS
    { id: 34, nombre: 'Temaki Langostino 1u', precio: 5400, cat: 'TEMAKIS', img: 'productos/temaki-langostino-1u.webp'},
    { id: 35, nombre: 'Temaki Salmon 1u', precio: 6900, cat: 'TEMAKIS', img: 'productos/temaki-salmon-1u.webp'}, 
    //SASHIMIS
    { id: 36, nombre: 'Sashimi Salmon 6p', precio: 10800, cat: 'SASHIMIS',img: 'productos/sashimi-salmon-6p.webp'}, 
    { id: 37, nombre: 'Sashimi Ahumado 6p', precio: 9300, cat: 'SASHIMIS', img: 'productos/sashimi-ahumado-6p.webp'}, 
    { id: 38, nombre: 'Sashimi Blanco 6p', precio: 5400, cat: 'SASHIMIS', img: 'productos/sashimi-blanco-6p.webp'},
    { id: 39, nombre: 'Sashimi Langostino 6p', precio: 8300, cat: 'SASHIMIS', img: 'productos/sashimi-langostino-6p.webp'},
    { id: 40, nombre: 'Sashimi Pulpo 6p', precio: 8900, cat: 'SASHIMIS', img: 'productos/sashimi-pulpo-6p.webp'},
    //NIGUIRIS
    { id: 41, nombre: 'Niguiri Salmon 6p', precio: 11400, cat: 'NIGUIRIS', img: 'productos/niguiri-salmon-6p.webp'},
    { id: 42, nombre: 'Niguiri Ahumado 6p', precio: 9600, cat: 'NIGUIRIS', img: 'productos/niguiri-ahumado-6p.webp'},
    { id: 43, nombre: 'Niguiri Langostino 6p', precio: 7900, cat: 'NIGUIRIS', img: 'productos/niguiri-langostino-6p.webp'},
    { id: 44, nombre: 'Niguiri Blanco 6p', precio: 6000, cat: 'NIGUIRIS', img: 'productos/niguiri-blanco-6p.webp'},
    { id: 45, nombre: 'Niguiri Pulpo 6p', precio: 9900, cat: 'NIGUIRIS', img: 'productos/niguiri-pulpo-6p.webp'},
    //GEISHAS
    { id: 46, nombre: 'Geisha Salmon 6p', precio: 12000, cat: 'GEISHAS', img: 'productos/geisha-salmon-6p.webp'}, 
    { id: 47, nombre: 'Geisha Ahumado 6p', precio: 10800, cat: 'GEISHAS', img: 'productos/geisha-ahumado-6p.webp'},
    { id: 48, nombre: 'Geisha Explosion 6p', precio: 12900, cat: 'GEISHAS', img: 'productos/geisha-explosion-6p.webp'}, 
    { id: 49, nombre: 'Geisha Langostino 6p', precio: 8400, cat: 'GEISHAS', img: 'productos/geisha-langostino-6p.webp'},
    //EXTRAS
