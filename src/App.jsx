...
const App = () => {
  ...
  const [productos] = useState([
    //COMBINADOS
    { id: 1, nombre: 'Combinado 15p', precio: 15000, cat: 'COMBINADOS', img: 'productos/combinado-15p.webp' }, 
    { id: 2, nombre: 'Combinado 30p', precio: 30000, cat: 'COMBINADOS', img: 'productos/combinado-30p.webp'}, 
    { id: 3, nombre: 'Combinado 45p', precio: 45000, cat: 'COMBINADOS', img: 'productos/combinado-45p.webp'}, 
    { id: 4, nombre: 'Combinado 60p', precio: 61000, cat: 'COMBINADOS', img: 'productos/combinado-60p.webp'}, 
    { id: 5, nombre: 'Roll & Roll 30p', precio: 31000, cat: 'COMBINADOS', img: 'productos/roll-y-roll-30p.webp'},
    { id: 6, nombre: 'Sushi Fan 30p', precio: 30000, cat: 'COMBINADOS', img: 'productos/sushi-fan-30p.webp'}, 
    //ROLLS
    { id: 7, nombre: 'Avocado 8p', precio: 6000, cat: 'ROLLS', img: 'productos/avocado-8p.webp'}, 
    { id: 8, nombre: 'Buenos Aires 8p', precio: 8500, cat: 'ROLLS', img: 'productos/buenos-aires-8p.webp'}, 
    { id: 9, nombre: 'California 8p', precio: 4000, cat: 'ROLLS', img: 'productos/california-8p.webp'},  
    { id: 11, nombre: 'Citrus 8p', precio: 5500, cat: 'ROLLS', img: 'productos/citrus-8p.webp'}, 
    { id: 12, nombre: 'Crazy 8p', precio: 6500, cat: 'ROLLS', img: 'productos/crazy-8p.webp'}, 
    { id: 13, nombre: 'Ebi Tempura 8p', precio: 5500, cat: 'ROLLS', img: 'productos/ebi-tempura-8p.webp'}, 
    { id: 14, nombre: 'Feel 8p', precio: 8000, cat: 'ROLLS', img: 'productos/feel-8p.webp'}, 
    { id: 15, nombre: 'Furay 8p', precio: 8000, cat: 'ROLLS', img: 'productos/furay-8p.webp'}, 
    { id: 16, nombre: 'Futurama 8p', precio: 8000, cat: 'ROLLS', img: 'productos/futurama-8p.webp'},
    { id: 17, nombre: 'Honey 8p', precio: 7500, cat: 'ROLLS', img: 'productos/honey-8p.webp'},  
    { id: 19, nombre: 'Philadelphia 8p', precio: 8000, cat: 'ROLLS', img: 'productos/philadelphia-8p.webp'}, 
    { id: 20, nombre: 'Placer Real 8p', precio: 15000, cat: 'ROLLS', img: 'productos/placer-real-8p.webp'}, 
    { id: 21, nombre: 'Spf 8p', precio: 7000, cat: 'ROLLS', img: 'productos/spf-8p.webp'}, 
    { id: 22, nombre: 'Sc Evolution 8p', precio: 6000, cat: 'ROLLS', img: 'productos/sc-evolution-8p.webp'}, 
    { id: 23, nombre: 'Smoke 8p', precio: 10000, cat: 'ROLLS', img: 'productos/smoke-8p.webp'}, 
    { id: 24, nombre: 'Soul 8p', precio: 15000, cat: 'ROLLS', img: 'productos/soul-8p.webp'}, 
    { id: 25, nombre: 'Sweet 8p', precio: 7000, cat: 'ROLLS', img: 'productos/sweet-8p.webp'},
    //COCINA
    ...
    { id: 29, nombre: 'Rabas 6u', precio: 8000, cat: 'COCINA', img: 'productos/rabas-6u.webp'},
    //MAKIS
    ...
    { id: 32, nombre: 'Maki Vegetariano 8p', precio: 3000, cat: 'MAKIS', img: 'productos/maki-vegetariano-8p.webp'}, 
    { id: 33, nombre: 'Maki Tuna 8p', precio: 4000, cat: 'MAKIS', img: 'productos/maki-tuna-8p.webp' },
    //TEMAKIS
    { id: 34, nombre: 'Temaki Langostino 1u', precio: 4000, cat: 'TEMAKIS', img: 'productos/temaki-langostino-1u.webp'},
    { id: 35, nombre: 'Temaki Salmon 1u', precio: 5000, cat: 'TEMAKIS', img: 'productos/temaki-salmon-1u.webp'}, 
    //SASHIMIS
    { id: 36, nombre: 'Sashimi Salmon 6p', precio: 11000, cat: 'SASHIMIS',img: 'productos/sashimi-salmon-6p.webp'}, 
    { id: 37, nombre: 'Sashimi Ahumado 6p', precio: 10000, cat: 'SASHIMIS', img: 'productos/sashimi-ahumado-6p.webp'}, 
    { id: 38, nombre: 'Sashimi Blanco 6p', precio: 6000, cat: 'SASHIMIS', img: 'productos/sashimi-blanco-6p.webp'},
    { id: 39, nombre: 'Sashimi Langostino 6p', precio: 6000, cat: 'SASHIMIS', img: 'productos/sashimi-langostino-6p.webp'},
    { id: 40, nombre: 'Sashimi Pulpo 6p', precio: 9000, cat: 'SASHIMIS', img: 'productos/sashimi-pulpo-6p.webp'},
    //NIGUIRIS
    { id: 41, nombre: 'Niguiri Salmon 6p', precio: 11000, cat: 'NIGUIRIS', img: 'productos/niguiri-salmon-6p.webp'},
    { id: 42, nombre: 'Niguiri Ahumado 6p', precio: 10000, cat: 'NIGUIRIS', img: 'productos/niguiri-ahumado-6p.webp'},
    { id: 43, nombre: 'Niguiri Langostino 6p', precio: 6000, cat: 'NIGUIRIS', img: 'productos/niguiri-langostino-6p.webp'},
    { id: 44, nombre: 'Niguiri Blanco 6p', precio: 6000, cat: 'NIGUIRIS', img: 'productos/niguiri-blanco-6p.webp'},
    { id: 45, nombre: 'Niguiri Pulpo 6p', precio: 9000, cat: 'NIGUIRIS', img: 'productos/niguiri-pulpo-6p.webp'},
    //GEISHAS
    { id: 46, nombre: 'Geisha Salmon 6p', precio: 12000, cat: 'GEISHAS', img: 'productos/geisha-salmon-6p.webp'}, 
    { id: 47, nombre: 'Geisha Ahumado 6p', precio: 11000, cat: 'GEISHAS', img: 'productos/geisha-ahumado-6p.webp'},
    { id: 48, nombre: 'Geisha Explosion 6p', precio: 12000, cat: 'GEISHAS', img: 'productos/geisha-explosion-6p.webp'}, 
    { id: 49, nombre: 'Geisha Langostino 6p', precio: 7000, cat: 'GEISHAS', img: 'productos/geisha-langostino-6p.webp'},
    //EXTRAS
